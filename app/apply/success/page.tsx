...
import { CheckCircle2, Printer, Edit, Loader2, CreditCard, ArrowLeft } from "lucide-react";
import { Button } from "@/components/ui/button";
import { Card, CardContent } from "@/components/ui/card";

// 1. All hooks and logic listening to params go here
function SuccessReceipt() {
  ...
  if (loading) return <div className="flex h-[400px] items-center justify-center"><Loader2 className="animate-spin text-primary" /></div>;
  if (!data) return <div className="text-center p-20 text-slate-500">Application not found.</div>;
  ...
  return (
    <>
      ...
      <Card className="border-none shadow-2xl bg-white overflow-hidden print:shadow-none print:border">
        <div className="text-center py-2 text-xs text-slate-400 font-medium tracking-wide border-b border-dashed bg-slate-50/50">
          SCHOOL RECEIPT
        </div>
...
// 2. The default export acts solely as a layout and hands off to Suspense
    ...
    <div className="min-h-screen bg-slate-50 py-12 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-center text-slate-400 text-xs mt-8">
          A confirmation message has been sent to your guardian's contact number.
        </p>
      </div>
    </div>
  );
